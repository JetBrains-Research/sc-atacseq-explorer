...
This is a copy of https://github.com/10XGenomics/cellranger/blob/master/lib/python/cellranger/analysis/irlb.py
...
def irlb(A, n, tol=0.0001, maxit=50, center=None, scale=None, random_state=0):
    ...
    while(it < maxit):
        ...
        for l in range(0, k): # THE ONLY DIFFERENCE - change xrange to range
            B[l, l] = S[1][l]
        B[0:k, k] = R[0:k]
